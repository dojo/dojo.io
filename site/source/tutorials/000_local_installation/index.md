...
{% aside 'Dojo create arguments' %}
	Many of the arguments passed to `dojo create` have shorter versions. So `dojo create -n first-dojo-2-app` is equivalent to `dojo create --name first-dojo-2-app`.
{% endaside %}
