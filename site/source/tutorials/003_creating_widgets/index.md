...
{% aside 'Remember' %}
You should already see the new values. However, if you shut down the build command, you can start it up again by running `dojo build --watch memory --serve` and navigating to `http://localhost:9999`.
{% endaside %}
